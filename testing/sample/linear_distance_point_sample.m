...
plot(x_dist_cvar(1, :), x_dist_cvar(2, :), 'k:', 'DisplayName', 'Dist. ES \epsilon=0.15', 'LineWidth', 2)
plot(x_dist_eps(1, :), x_dist_eps(2, :), 'r', 'DisplayName', 'Dist. VP \epsilon=0.15', 'LineWidth', 2)
