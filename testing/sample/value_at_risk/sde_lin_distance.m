%maximum of the negative squared distance
...
p = @(x) arrayfun(@(xc1, xc2) pper([xc1; xc2]), squeeze(x(:, 1, :)), squeeze(x(:, 2, :)));
...
%% save output
save('dist_lin_traj_quantile_cvar.mat', 'max_cvar', 'max_q', 'epsilon_list', 'q_smp', 't_smp', 'max_smp')
