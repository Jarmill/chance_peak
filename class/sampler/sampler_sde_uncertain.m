classdef sampler_sde_uncertain < sampler_uncertain_interface
    %SAMPLER_SDE_UNCERTAIN Summary of this class goes here
    ...
    methods
        function obj = sampler_sde_uncertain(loc,sampler)
...
%       'Antithetic', Antithetic);
            ...
            while time_total < Tmax
                ...
                curr_g = @(t, x) curr_sys.g_eval([t; x; th0; w_curr; b_curr]);
